...
#-------------------config--------------------------------
pretrained_path =  '/home/bits/Trainer/License_Plate_Recognition/Recognizer2/weights/Final_LPRNet_model.pth'
dataset_path ='/home/bits/Trainer/License_Plate_Recognition/Recognizer/datasets/CCPD2019'
export_model_name =  'lpr'


input_shape = (3, 24, 94)
max_sample_image_num = 300
net = build_lprnet(lpr_max_len=8, phase='test', class_num=len(CHARS), dropout_rate=0.2)
...
import torch.onnx
export_dir = f'export/{export_model_name}'
...
torch_to_onnx(net,input_shape,out_name=onnx_path,output_names = ["output0"])
...
awnn_quantize_image_path = f'quantize_images/{export_model_name}'
