...
from models.net import PLNet as PLNet
...
class RetinaFace(nn.Module):
    ...
    def forward(self,inputs):
        ...
        print("fpn 1 shape:",fpn[0].shape)
        print("fpn 2 shape:",fpn[1].shape)
        print("fpn 3 shape:",fpn[2].shape)
