...
def get_parser():
    ...
    parser.add_argument('--train_img_dirs', default="/home/bits/Trainer/License_Plate_Recognition/Recognizer/datasets/CCPD2019", help='the train images path')
    ...
    parser.add_argument('--train_batch_size', default=440, help='training batch size.')
    parser.add_argument('--test_batch_size', default=120, help='testing batch size.')
    parser.add_argument('--phase_train', default=True, type=bool, help='train or test phase flag.')
    parser.add_argument('--num_workers', default=88, type=int, help='Number of workers used in dataloading')
...
def train():
    ...
    # train_dataset = LPRDataLoader(args.test_img_dirs, args.img_size, args.lpr_max_len)
    ...
    for iteration in range(start_iter, max_iter):
        ...
        # forward
        log_probs = lprnet(images)
        log_probs = log_probs.permute(2, 0, 1).contiguous()# for ctc loss: T x N x C
...
def Greedy_Decode_Eval(Net, datasets, args):
    ...
    for i in range(epoch_size):
        ...
        # forward
        prebs = Net(images)
        # prebs.permute(1,2,0).contiguous()
        # greedy decode
