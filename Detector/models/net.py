...
class PLNet(nn.Module):
    def __init__(self):
        ...
        self.stage2 = nn.Sequential(
            conv_bn(64, 128, 2),  # 43 + 16 = 59
            conv_bn(128, 128, 1), # 59 + 32 = 91
            conv_bn(128, 128, 1), # 91 + 32 = 123
            conv_bn(128, 128, 1), # 123 + 32 = 155
            conv_bn(128, 128, 1), # 155 + 32 = 187
            conv_bn(128, 128, 1), # 187 + 32 = 219
        )
        self.stage3 = nn.Sequential(
            conv_bn(128, 256, 2), # 219 +3 2 = 241
            conv_bn(256, 256, 1), # 241 + 64 = 301
        )
        self.avg = nn.AdaptiveAvgPool2d((1,1))
        self.fc = nn.Linear(256, 1000)
