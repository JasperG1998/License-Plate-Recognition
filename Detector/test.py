...
parser.add_argument('-m', '--trained_model', default='/home/bits/Trainer/License_Plate_Recognition/Detector/weights/slim_224_rgb_224x224_epoch_47.pth',
...
parser.add_argument('--save_folder', default='/home/bits/Trainer/License_Plate_Recognition/Detector/results', type=str, help='Dir to save txt results')
...
if __name__ == '__main__':
    ...
    # testing begin
    for i in range(1):
        image_path = "/home/bits/Trainer/License_Plate_Recognition/Detector/images/0075-0_0-101&180_158&200-158&199_102&200_101&181_158&180-0_0_26_25_8_32_29-85-16.jpg"
        ...
        if args.save_image:
            ...
            name = "test.jpg"
            cv2.imwrite(f"{args.save_folder}/{name}", img_raw)
